...
if(D.process){entries.unshift({id:'process-overview',symbol:t('Process overview'),kind:'PROCESS',trigger:{methods:['PROCESS'],paths:[]},sourceIds:[]});if(!entries.some(e=>e.id===D.process.definition.id))entries.push({id:D.process.definition.id,symbol:t('Detailed process flow'),kind:'SCENARIO',trigger:{methods:['FLOW'],paths:[]},sourceIds:[]});}
