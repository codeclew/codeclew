#!/usr/bin/env python3
"""Verify an S2K retained impact root and its exact readable CAS closure."""
...
RESULT_SCHEMA = "codeclew-thread-impact-retention-verification/1.0"
ROOT_SCHEMA = "codeclew-thread-impact-root/1.0"
