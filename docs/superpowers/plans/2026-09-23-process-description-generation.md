...
**Goal:** In codeclew, auto-generate the "Подробный порядок действий" (detailed order of actions) for a process/scenario operation from retained flow evidence, bound to source, and emit it as PlantUML (`.puml`) + pre-rendered SVG — auto by default, human-authored sequence takes priority.
...
Run: `cd /Users/e.khlyzov/repo/research/codeclew && CARGO_NET_OFFLINE=true cargo test --locked -p clew --lib documentation::plantuml:: -- --test-threads=1`
...
pub fn activity_from_flow(events: &Value, symbol: &str) -> Option<String> {
    ...
    for (i, row) in rows.iter().enumerate() {
        ...
        match kind {
            ...
            "ELSE" | "ELSEIF" => out.push_str(&format!("else (нет)\n")),
...
```sh
cd /Users/e.khlyzov/repo/research/codeclew
JAVA_HOME=/Users/e.khlyzov/Library/Java/JavaVirtualMachines/jdk-17.0.20+8/Contents/Home \
CODECLEW_WORKER_JAVA_HOME=/Users/e.khlyzov/Library/Java/JavaVirtualMachines/jdk-21.0.12+8/Contents/Home \
CARGO_NET_OFFLINE=true ./clew docs render --root /Users/e.khlyzov/repo/kasko/arch-kasko
ls /Users/e.khlyzov/repo/kasko/arch-kasko/docs/generated/*/diagrams/*.puml
```
