...
The smoke run must select Kotlin 2.3.0, index the target sources with K2 validation, expose Maven validation commands, and resolve the archive/changefeed edit surface without modifying the Ladadigit repository.
