...
Historical site redesign review, 2026-09-08; preserved on 2026-09-13.

The following result describes that review only. Later release-content changes
are recorded in [repository consolidation](repository-consolidation-20260913.md).
