...
> Historical experiment, preserved on 2026-09-13. The optional candidate is
> retained on [`archive/preloaded-context`](https://github.com/codeclew/codeclew/tree/archive/preloaded-context);
> its runtime changes are not part of the 0.8.0 release. See the
